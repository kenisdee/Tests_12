...
# Применяем декоратор к методам классов, кроме @classmethod
...
# Добавляем тесты из RunnerTest и TournamentTest в TestSuite с использованием loadTestsFromTestCase
